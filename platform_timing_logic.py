...
def should_skip_timing_assertion(time_value: float, min_threshold: float = 0.0001) -> bool:
    """
...
def evaluate_timing_performance(
    ...
    min_time_threshold: float = 0.0001
    ...
    if (should_skip_timing_assertion(baseline_time, min_time_threshold) or 
        should_skip_timing_assertion(optimized_time, min_time_threshold)):
        return (
            False, 
            None, 
    ...
    speed_improvement = baseline_time / optimized_time if optimized_time > 0 else float('inf')
