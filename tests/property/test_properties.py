...
def country_list_with_mock(draw):
    ...
    mock_data = {
        ...
        "name_official": [
            "United States of America", "Canada", "Federal Republic of Germany", "Japan", "Federative Republic of Brazil",
            "French Republic", "Italian Republic", "Kingdom of Spain", "United Kingdom of Great Britain and Northern Ireland", "Commonwealth of Australia",
            "People's Republic of China", "Republic of India", "Russian Federation", "United Mexican States", "Republic of Korea"
        ],
        "region": [
            "Americas", "Americas", "Europe", "Asia", "Americas",
            "Europe", "Europe", "Europe", "Europe", "Oceania",
            "Asia", "Asia", "Europe", "Americas", "Asia"
        ],
        "sub_region": [
            "Northern America", "Northern America", "Western Europe", "Eastern Asia", "South America",
            "Western Europe", "Southern Europe", "Southern Europe", "Northern Europe", "Australia and New Zealand",
            "Eastern Asia", "Southern Asia", "Eastern Europe", "Central America", "Eastern Asia"
        ],
    }
...
def test_getflag_length(data):
    ...
    with patch.object(CountryConverterSingleton, '__new__') as mock_singleton:
        ...
        mock_instance = type('MockInstance', (), {
            ...
            'convert': lambda self, name, to="ISO2": MockConverter().convert(name, to)
        })()
...
def test_get_flags_by_region(region):
    ...
    with patch.object(CountryConverterSingleton, '__new__') as mock_singleton:
        ...
        mock_instance = type('MockInstance', (), {
            ...
            '_converter': MockConverter(),
            'convert': lambda self, name, to="ISO2": MockConverter().convert(name, to),
            'get_countries_by_region': lambda self, region: MockConverter().get_countries_by_region(region)
        })()
        mock_singleton.return_value = mock_instance
        cf = CountryFlag()
